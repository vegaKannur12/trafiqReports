...
class LevelTwo extends StatefulWidget {
  ...
  String filter_id;
  String tile;
  LevelTwo({required this.old_filter_where_ids, required this.filter_id,required this.tile});
  @override
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushReplacement(
            context, new MaterialPageRoute(builder: (context) => LevelOne(old_filter_where_ids: widget.old_filter_where_ids,filter_id: widget.filter_id,tilName: widget.tile,)));
        return true;
      },
      child: Scaffold(
